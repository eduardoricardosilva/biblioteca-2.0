...
from livros import montar_tela_livros

ctk.set_appearance_mode("dark")
ctk.set_default_color_theme("green")

def montar_menu_principal(janela_principal):
    ...
    janela_principal.configure(fg_color="#dff3df")
    ...
    btn_livros = ctk.CTkButton(
        frame_btn_livros,
        text="Livros",
        command=lambda: montar_tela_livros(
            janela_principal, montar_menu_principal),
